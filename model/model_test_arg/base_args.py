...
class BaseArgs():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--num_seq', default=256, type=int, help='height of patch (default: 64)')
        ...
        # for joint task
        parser.add_argument('--num_rfab', default=8, type=int, help='number of  residual feature attention block')
