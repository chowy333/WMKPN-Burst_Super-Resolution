...
class NET(nn.Module):
    def __init__(self, args):
        ...
        m_global_res = [nn.ReflectionPad2d((1,1,1,1)), RTAB(num_seq * in_channels), ConvBlock_2D(num_seq * in_channels, (scale*2)**2*3, kernel_size = (3,3), padding =0, bias = bias), nn.PixelShuffle(scale*2)]
...
#print("final shape =", model(input).shape)
#k = torch.randn((16,128, 50, 50))
