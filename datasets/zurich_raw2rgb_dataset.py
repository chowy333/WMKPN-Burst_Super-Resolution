...
#                                                                                           burst_transformation_params=self.burst_transformation_#params,
...
#base_data = ZurichRAW2RGB(root ="/home/wooyeong/Burst/burstsr_dataset/Zurich_Public/")
#len(base_data)
#base_data[0].shape
#burst= SyntheticBurst(base_dataset=base_data)
#len(burst)
#train, val = torch.utils.data.random_split(burst, [int(len(burst) * 0.8), len(burst) - int(len(burst) * 0.8)])
#len(train) + len(val)
#a, b, c, d = burst[0]
#a.shape
#b.shape
#c.shape
#train_loader = DataLoader(dataset=burst, num_workers=8, batch_size=8,
